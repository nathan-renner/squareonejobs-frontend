...
function EULA(props) {
  return (
    <div className="landing legal-page">
      <Navbar className="navbar-light" fixed noShadow={true} />
      <div className="container-xs">
        <h2>
          End-User License Agreement (EULA) of{" "}
          <span class="app_name">SquareOneJobs</span>
        </h2>

        <p>
          This End-User License Agreement ("EULA") is a legal agreement between
          you and <span class="company_name">SquareOneJobs, Inc.</span>. Our
          EULA was created by{" "}
        ...
        <p>
          ...
          <span class="app_name">SquareOneJobs</span> software ("Software")
          directly from <span class="company_name">SquareOneJobs, Inc.</span> or
          indirectly through a{" "}
          <span class="company_name">SquareOneJobs, Inc.</span> authorized
        ...
        <p>
          ...
          <span class="app_name">SquareOneJobs</span> software. It provides a
          license to use the <span class="app_name">SquareOneJobs</span>{" "}
          software and contains warranty information and liability disclaimers.
        </p>

        <p>
          If you register for a free trial of the{" "}
          <span class="app_name">SquareOneJobs</span> software, this EULA
          agreement will also govern that trial. By clicking "accept" or
          installing and/or using the{" "}
          <span class="app_name">SquareOneJobs</span> software, you are
        ...
        <p>
          ...
          <span class="company_name">SquareOneJobs, Inc.</span> herewith
          regardless of whether other software is referred to or described
          herein. The terms also apply to any{" "}
          <span class="company_name">SquareOneJobs, Inc.</span> updates,
        ...
        <p>
          <span class="company_name">SquareOneJobs, Inc.</span> hereby grants
          you a personal, non-transferable, non-exclusive licence to use the{" "}
          <span class="app_name">SquareOneJobs</span> software on your devices
          in accordance with the terms of this EULA agreement.
        </p>

        <p>
          You are permitted to load the{" "}
          <span class="app_name">SquareOneJobs</span> software (for example a
          PC, laptop, mobile or tablet) under your control. You are responsible
          for ensuring your device meets the minimum requirements of the{" "}
          <span class="app_name">SquareOneJobs</span> software.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <span class="company_name">SquareOneJobs, Inc.</span> considers is a
        ...
        <p>
          <span class="company_name">SquareOneJobs, Inc.</span> shall at all
          times retain ownership of the Software as originally downloaded by you
          and all subsequent downloads of the Software by you. The Software (and
          ...
          <span class="company_name">SquareOneJobs, Inc.</span>.
        </p>

        <p>
          <span class="company_name">SquareOneJobs, Inc.</span> reserves the
          right to grant licences to use the Software to third parties.
        </p>
